...
- [x] 07-01-PLAN.md — Trace durable repository/checkout hierarchy and selection through real App data into Ratatui.
...
- [x] 07-06-PLAN.md — Complete readiness-only docs/runbook and run the final non-publishing local readiness gate.
